...
class Activité
{
    ...
    #[Assert\NotBlank(message: "Please enter an activity name")]
    #[Assert\Length(max: 50, maxMessage: "Activity name cannot be longer than 50 characters")]
    private ?string $nom = null;

    #[ORM\Column(length: 300)]
    #[Assert\NotBlank(message: "Please enter a description")]
    #[Assert\Length(max: 300, maxMessage: "Description cannot be longer than 300 characters")]
    ...
    #[Assert\NotNull(message: "Please select an activity type")]
